...
public class GradingSystem {
  ...
  public char getGrade(int percentage) {
    ...
    else if(percentage>=70 && percentage<=79) return 'C';
    // If it's 60-69, return 'D'.
    else if(percentage>=60 && percentage<=69) return 'D';
    // If it's less than 60, return 'F'.
    else if(percentage<60) return 'F';
    else return 'X';
  }
  ...
  public String retakeMessage(int percentage, boolean allowedToRetake) {
    ...
    if(percentage<60 && allowedToRetake==true){ 
      String s ="The student has been entered for a retake.";
      return s; }
    ...
    if (percentage < 60 && allowedToRetake == false){ 
      String s = "The student is not allowed to retake this exam."; 
      return s; }

    // If percentage is 60 or higher, return a String that says "A retake is not
    // required."
    if (percentage > 60) {
      String s =  "A retake is not required.";
      return s;}
      return "";
  }
